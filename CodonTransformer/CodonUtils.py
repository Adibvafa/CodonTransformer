...
TOKEN2INDEX: Dict[str, int] = {
    '[UNK]': 0, '[CLS]': 1, '[SEP]': 2, '[PAD]': 3, '[MASK]': 4, 'a_unk': 5, 'c_unk': 6, 'd_unk': 7, 'e_unk': 8,
    'f_unk': 9, 'g_unk': 10, 'h_unk': 11, 'i_unk': 12, 'k_unk': 13, 'l_unk': 14, 'm_unk': 15, 'n_unk': 16, 'p_unk': 17,
    'q_unk': 18, 'r_unk': 19, 's_unk': 20, 't_unk': 21, 'v_unk': 22, 'w_unk': 23, 'y_unk': 24, '__unk': 25, 'k_aaa': 26,
    'n_aac': 27, 'k_aag': 28, 'n_aat': 29, 't_aca': 30, 't_acc': 31, 't_acg': 32, 't_act': 33, 'r_aga': 34, 's_agc': 35,
    'r_agg': 36, 's_agt': 37, 'i_ata': 38, 'i_atc': 39, 'm_atg': 40, 'i_att': 41, 'q_caa': 42, 'h_cac': 43, 'q_cag': 44,
    'h_cat': 45, 'p_cca': 46, 'p_ccc': 47, 'p_ccg': 48, 'p_cct': 49, 'r_cga': 50, 'r_cgc': 51, 'r_cgg': 52, 'r_cgt': 53,
    'l_cta': 54, 'l_ctc': 55, 'l_ctg': 56, 'l_ctt': 57, 'e_gaa': 58, 'd_gac': 59, 'e_gag': 60, 'd_gat': 61, 'a_gca': 62,
    'a_gcc': 63, 'a_gcg': 64, 'a_gct': 65, 'g_gga': 66, 'g_ggc': 67, 'g_ggg': 68, 'g_ggt': 69, 'v_gta': 70, 'v_gtc': 71,
    'v_gtg': 72, 'v_gtt': 73, '__taa': 74, 'y_tac': 75, '__tag': 76, 'y_tat': 77, 's_tca': 78, 's_tcc': 79, 's_tcg': 80,
    's_tct': 81, '__tga': 82, 'c_tgc': 83, 'w_tgg': 84, 'c_tgt': 85, 'l_tta': 86, 'f_ttc': 87, 'l_ttg': 88, 'f_ttt': 89
}
...
TOKEN2MASK: Dict[int, int] = {
    ...
    17: 17, 18: 18, 19: 19, 20: 20, 21: 21, 22: 22, 23: 23, 24: 24, 25: 25, 26: 13, 27: 16, 28: 13, 29: 16, 30: 21,
    31: 21, 32: 21, 33: 21, 34: 19, 35: 20, 36: 19, 37: 20, 38: 12, 39: 12, 40: 15, 41: 12, 42: 18, 43: 11, 44: 18,
    45: 11, 46: 17, 47: 17, 48: 17, 49: 17, 50: 19, 51: 19, 52: 19, 53: 19, 54: 14, 55: 14, 56: 14, 57: 14, 58: 8,
    59: 7, 60: 8, 61: 7, 62: 5, 63: 5, 64: 5, 65: 5, 66: 10, 67: 10, 68: 10, 69: 10, 70: 22, 71: 22, 72: 22, 73: 22,
    74: 25, 75: 24, 76: 25, 77: 24, 78: 20, 79: 20, 80: 20, 81: 20, 82: 25, 83: 6, 84: 23, 85: 6, 86: 14, 87: 9, 88: 14,
    89: 9
}

# List of organisms used for fine-tuning
FINE_TUNE_ORGANISMS: List[str] = [
    'Arabidopsis thaliana', 'Bacillus subtilis', 'Caenorhabditis elegans', 'Chlamydomonas reinhardtii',
    'Chlamydomonas reinhardtii chloroplast', 'Danio rerio', 'Drosophila melanogaster', 'Homo sapiens', 'Mus musculus',
    'Nicotiana tabacum', 'Nicotiana tabacum chloroplast', 'Pseudomonas putida', 'Saccharomyces cerevisiae',
    'Escherichia coli O157-H7 str. Sakai', 'Escherichia coli general', 'Escherichia coli str. K-12 substr. MG1655',
...
def get_taxonomy_id(taxonomy_reference: str, organism: Optional[str] = None, return_dict: bool = False) -> Any:
    """
